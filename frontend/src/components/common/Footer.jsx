    ...
    <footer className="border-t border-slate-800 bg-slate-900/50 backdrop-blur text-white text-xs py-4 px-6 mt-auto">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-4 text-white">
          <a href="#privacy" className="hover:text-amber-200 transition-colors">Privacy Policy</a>
          <a href="#terms" className="hover:text-amber-200 transition-colors">Terms of Service</a>
          <a href="#contact" className="hover:text-amber-200 transition-colors">Support</a>
        </div>
      </div>
    </footer>
  );
